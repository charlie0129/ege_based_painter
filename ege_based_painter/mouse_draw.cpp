            ...
            case mouse_msg_up:
                ...
                if (isInProgress)
                {
                    ...
                    printf("	已画出以 (%d, %d) 为圆心，(%d, %d) 为圆上一点，半径为 %d 的一个圆\n",
                           ...
                           circleOuterX,
                           circleOuterY,
                           (int)sqrt(pow(shapeData[g_nTotalShapes - 1].coords[0].x -
                                         shapeData[g_nTotalShapes - 1].coords[1].x, 2) +
                                     pow(shapeData[g_nTotalShapes - 1].coords[0].y - shapeData[g_nTotalShapes -
                                             1].coords[1].y, 2)));
